...
```{r ans11}
a <- c(20,10,15)
surface_A <- as.integer( 2*a[[1]]*a[[2]]+2*a[[2]]*a[[3]]+2*a[[1]]*a[[3]])
surface_A
```
...
```{r ans12}
surface_cube <- function(a,b,c){2*a*b+2*b*c+2*a*c}
...
get_courses <- function(entranceYear, major){
 entranceYear <- courseStructure$`學年`
 major <- courseStructure$`應修系級`
}
